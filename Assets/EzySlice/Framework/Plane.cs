...
namespace EzySlice {
    ...
    public struct Plane {
         ...
         * Version.
         */
        public void OnDebugDraw(Vector3 size) {
            OnDebugDraw(size, Color.white);
        }

        public void OnDebugDraw(Vector3 size, Color drawColor) {
            ...
            Gizmos.DrawWireCube(Vector3.zero, new Vector3(size.x, 0.0f, size.z));
